def place_order(menu):
    ...
    # Set the initial order total to 0.0
    order_total = 0.0
    ...
    print("Welcome to Nina\'s Eats online ordering.")

    place_order = True

    # TODO: Create a continuous while loop so customers can order multiple items
    while True:
        # TODO: Loop through the menu dictionary, extracting the food category and the options for each category
        i = 1

        print_menu_heading()
        # TODO: Loop through the options for each food category, extracting the meal and the price
        ...
        menu_selection = input(
            "Enter the number of the menu item you would like to order: ")
        ...
        next_item = input(
            "Would you like to order another item? Y for yes or N for no: ")

        # TODO: Write a conditional statement that checks if the customer types
        # 'n' or 'N'
        if next_item.lower() == 'n':
...
def update_order(order, menu_selection, menu_items):
    ...
    if menu_selection.isdigit():
        ...
        if menu_selection in menu_items:
            ...
            # otherwise, tell the customer that the menu item number is invalid
...
def print_menu_line(index, food_category, meal, price):
    ...
    if index < 10:
        ...
        i_spaces = " " * 5
    print(
        f"{index}{i_spaces}| {food_category} - {meal}{item_spaces} | ${price}")
